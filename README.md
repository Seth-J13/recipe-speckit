...
|----|------|--------|------------|
| 1 | [features/1-menu-bar.md](features/1-menu-bar.md) | `feature/1-menu-bar` | — |
| 2 | [feature-2-sign-in-sign-out.md](features/feature-2-sign-in-sign-out.md) | `feature/2-sign-in-sign-out` | Feature 1 — Create account |
