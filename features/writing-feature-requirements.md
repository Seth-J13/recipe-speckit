...
- [x] It does not sound like a single user story
- [x] kebab-case short-name is readable in `feature/N-short-name`
- [x] It will not be confused with another planned feature’s name
